module github.com/liuxd6825/dapr-components-contrib/tests/e2e/pubsub/jetstream
...
require (
	...
	github.com/liuxd6825/dapr-components-contrib v1.10.6-0.20230403162214-9ee9d56cb7ea
)
