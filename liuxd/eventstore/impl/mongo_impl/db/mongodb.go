...
const (
	...
	defaultEventCollectionName     = "event"
	defaultSnapshotCollectionName  = "snapshot"
	defaultAggregateCollectionName = "aggregate"
	defaultRelationCollectionName  = "relation"
	defaultMessageCollectionName   = "message"
...
func NewMongoDB(componentName string, logger logger.Logger) *MongoDbConfig {
	mdb := common.NewMongoDB(componentName, logger)
	s := &MongoDbConfig{
		MongoDB: mdb,
	}
	return s
