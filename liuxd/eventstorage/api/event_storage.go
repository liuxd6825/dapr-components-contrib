...
import (
	...
	"github.com/liuxd6825/dapr-components-contrib/liuxd/eventstorage/domain/service"
...
func (s *EventStorage) Init(ctx context.Context, opts *eventstorage.Options) error {
...
// @return error
func (s *EventStorage) Commit(aCtx context.Context, req *dto.CommitRequest) (*dto.CommitResponse, error) {
...
// @return error
func (s *EventStorage) Rollback(ctx context.Context, req *dto.RollbackRequest) (*dto.RollbackResponse, error) {
...
// @return error
func (s *EventStorage) ApplyEvent(ctx context.Context, req *dto.ApplyEventsRequest) (resp *dto.ApplyEventsResponse, reserr error) {
	defer func() {
		if e := recover(); e != nil {
...
// @return error
func (s *EventStorage) doCreateEvent(ctx context.Context, req *dto.ApplyEventsRequest, eventDto *dto.EventDto) error {
	isDuplicateEvent := false
...
// @return error
func (s *EventStorage) doApplyEvent(ctx context.Context, req *dto.ApplyEventsRequest, eventDto *dto.EventDto) error {
...
// @return error
func (s *EventStorage) doDeleteEvent(ctx context.Context, req *dto.ApplyEventsRequest, eventDto *dto.EventDto) error {
	aggType, err := s.getFieldValue(req.AggregateType, eventDto)
	if err != nil {
		return err
	}
...
func (s *EventStorage) saveEvents(ctx context.Context, tenantId string, sessionId string, aggregateId string, aggregateType string, eventDtoList []*dto.EventDto, startSequenceNumber uint64) error {
	if eventDtoList == nil {
...
func (s *EventStorage) saveEvent(ctx context.Context, event *model.Event, relations []*model.Relation) (reserr error) {
	defer func() {
		if e := recover(); e != nil {
			if err, ok := e.(error); ok {
				reserr = err
...
func (s *EventStorage) publishEvent(ctx context.Context, event *model.Event) error {
	// 发送事件到消息队列，并设置 PublishStatus 为 PublishStatusSuccess
	if err := s.publishMessage(ctx, event, false); err != nil {
		return err
	}
...
func (s *EventStorage) deleteEventBySessionId(ctx context.Context, tenantId string, sessionId string) error {
...
func (s *EventStorage) newAggregateEntity(req *dto.ApplyEventsRequest) (*model.Aggregate, error) {
...
func (s *EventStorage) doSession(ctx context.Context, tenantId string, fun func(ctx context.Context) (any, error), opts ...*SessionOptions) (any, error) {
	var data interface{}
	var err error
...
func (s *EventStorage) getFieldValue(value string, eventDto *dto.EventDto) (string, error) {
